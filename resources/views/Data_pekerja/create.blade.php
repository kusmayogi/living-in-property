                        ...
                        @csrf
                         <div class="row">
                             <div class="column">
                                 ...
                                 <input type="text" id="nama_pekerja" class="form-control" placeholder="Nama Pekerja"  name="nama_pekerja" value="{{ old('nama_pekerja') }}" required>
                             </div>
                             <div class="column">
                                <label for="judul">Status</label>
                                <input type="text" id="role" class="form-control" placeholder="Status"  name="role" value="{{ old('role') }}" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="column">
                                <label for="judul">Upah</label>
                                <input type="text" id="upah" class="form-control" placeholder="Upah"  name="upah" value="{{ old('upah') }}" required>
                            </div>
                        <div class="column">
                            ...
                            <select id="id_proyek" class="form-control" name="id_proyek">
                                    ...
                                    @foreach($allProyeks as $proyek)
                                        <option value="{{ $proyek->id_proyek}}">{{ $proyek->lokasi_proyek }}</option>
                                    @endforeach
                            </select>
                        </div>
