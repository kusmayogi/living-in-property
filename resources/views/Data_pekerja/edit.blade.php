        ...
        <div class="main--content">
                <div class="overview">
                   ...
                   <div class="container">
                    ...
                    <form action="{{ route('Data_pekerja.update', $pekerja->id_pekerja) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <form>
                         <div class="row">
                             <div class="column">
                               <label for="judul">Nama Pekerja</label>
                                 <input type="text" class="form-control" id="nama_pekerja" name="nama_pekerja" value="{{ $pekerja->nama_pekerja }}" required>
                             </div>
                             <div class="column">
                         ...
                         <div class="row">
                            <div class="column">
                                ...
                                <input type="text" class="form-control" id="upah" name="upah" value="{{ $pekerja->upah }}" required>
                            </div>
                            <div class="column">
                                <label for="judul">Kasbon</label>
                                <input type="text" class="form-control" id="jumlah_kasbon" name="jumlah_kasbon" value="{{ $pekerja->jumlah_kasbon }}" required>
                            </div>
                            ...
                            <div class="column">
                                ...
                                <select id="id_proyek" class="form-control" name="id_proyek">
                                    ...
                                    @foreach($allProyeks as $proyek)
                                        <option value="{{ $proyek->id_proyek }}" @if($proyek->id_proyek == $pekerja->id_proyek) selected @endif>
