        ...
        <div class="main--content">
                <div class="overview">
                   ...
                   <div class="container">
                    ...
                    <form action="{{ route('proyek.update', $proyeks->id_proyek) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <form>
                         <div class="row">
                             <div class="column">
                                 ...
                                 <input type="text" class="form-control" id="nama_pemilik" name="nama_pemilik" value="{{ $proyeks->nama_pemilik }}" required>
                             </div>
                             <div class="column">
                                 <label for="judul">Lokasi Proyek</label>
                                 <input type="text" class="form-control" id="lokasi_proyek" name="lokasi_proyek" value="{{ $proyeks->lokasi_proyek }}" required>
                             </div>
                         </div>
                         <div class="row">
                            <div class="column">
                                <label for="tanggal_dimulai">Tanggal Dimulai</label>
                                <input type="text" class="form-control" id="tanggal_dimulai" name="tanggal_dimulai" value="{{ $proyeks->tanggal_dimulai}}" required>
                            </div>
                            <div class="column">
                                <label for="tanggal_selesai">Tanggal Selesai</label>
                                <input type="text" class="form-control" id="tanggal_selesai" name="tanggal_selesai" value="{{ $proyeks->tanggal_selesai}}" >
                            </div>
                        </div>
                         ...
                         <div class="row">
                             ...
                             <div class="column">
                                ...
                                <input type="text" class="form-control" id="nilai_proyek" name="nilai_proyek" value="{{ $proyeks->nilai_proyek }}" required>
                            </div>
                         </div>
