                            ...
                            <div class="row">
                                <div class="column">
                                    ...
                                    <input type="text" id="nama_pemilik" class="form-control"
                                        placeholder="Nama Pemilik" name="nama_pemilik" value="{{ old('nama_pemilik') }}"
                                        required>
                                </div>
                                <div class="column">
                                    <label for="judul">Lokasi Proyek</label>
                                    <input type="text" id="lokasi_proyek" class="form-control"
                                        placeholder="Lokasi Proyek" name="lokasi_proyek"
                                        value="{{ old('lokasi_proyek') }}" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="column">
                                    <label for="tanggal_publikasi">Tanggal Dimulai</label>
                                    <input type="datetime-local" class="form-control" id="tanggal_dimulai"
                                        placeholder="Tanggal Dimulai" name="tanggal_dimulai"
                                        value="{{ old('tanggal_dimulai') }}" required>
                                </div>
                                <div class="column">
                                    <label for="judul">Nilai Proyek</label>
                                    <input type="text" id="nilai_proyek" class="form-control"
                                        placeholder="Nilai Proyek" name="nilai_proyek"
                                        value="{{ old('nilai_proyek') }}" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="column">
