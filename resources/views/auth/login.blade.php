...
<head>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="inp">
            ...
            required autocomplete="email" oninvalid="this.setCustomValidity('Harap lengkapi username anda')" 
...
          </div>
        ...
        <div class="inp">
            ...
            oninput="this.setCustomValidity('')"
            placeholder="Password Berisi 8 Karakter"/>
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <button class="btn btn-google btn-login text-uppercase fw-bold" id="afdnfbdsfui" type="submit">
