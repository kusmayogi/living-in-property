...
<body>
    ...
    <section class="main">
        ...
        <div class="main--content">
            <div class="overview">
                <div class="title">
                    <h2 title="section--title">Pengeluaran Keuangan</h2>
                </div>
                <a href="{{ route('pengeluaran.create') }}" class="ri-edit-line edit">Tambah Pengeluaran</a>
                <div class="table">
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($pengeluarans as $index => $pengeluaran)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $pengeluaran->judul_pengeluaran }}</td>
                                    <td>{{ $pengeluaran->created_at }}</td>
                                    <td>
                                        <div class="button-container">
                                            <a href="{{ route('pengeluaran.detail', $pengeluaran->id_pengeluaran) }}" class="ri-edit-line edit">Detail</a>
                                            </div>
                                    </td>
                                </tr>
                            @endforeach
